...
public class MergeSort {
    ...
    public static void merge(int inputArray[], int start, int mid, int end) {
        ...
        /**
         * When it get's to here, that means the above loop has completed. So
         * both the right and the left side of the sub-array can be considered
         * sorted
         */
    ...
    // **************************************************************************
    /**
     * Hopefully you were able to complete the above merge() method Below is a
     * more challenging implementation. It's called an in-place merge. This is
     * usually pretty difficult for even average programmers to wrap their head
     * around. If you put in the effort to try and understand the below code,
     * you will certainly get it. Here is an incentive for you to put in the
     * time: If you can email me a detailed easy to read explanation in your own
     * words about how the below code works, I'll provide you a 75% discount for
     * all my current and future courses on my online school! my email address
     * is imtiaz@eliminatecodefear.com
     *
     * <br>
     * <b> GOOD LUCK!<b>
     *
