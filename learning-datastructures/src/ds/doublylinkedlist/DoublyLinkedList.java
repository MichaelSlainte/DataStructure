...
public class DoublyLinkedList {
    ...
    public void insertLast(int data) {
        ...
        if (isEmpty()) {
            ...
            last.next = newNode; //assingning old last to newnode
    ...
    public Node deleteFirst() {
        ...
        first = first.next; // we are assinging the reference of the node following the old first node to the first field in the linked list object
    ...
    public Node deleteKey(int key) {
        Node current = first; //start fomr de beginning
        ...
        if (current == first) {
            first = current.next; //make the field point to the node following current since current will be deleted
        } else {
